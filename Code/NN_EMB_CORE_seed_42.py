...
1. Add Relu after concatenating the embeddings of the categorical variables (only changed the forward method)
...
#------Result File ----------
results_file = f"/home/aniketb/scratch/output_paper1/emb_0_arch_1/results_seed_{seed}.txt"

#---- Summary Writer for logs 
# The base directory for tensorboard logs
base_dir = f"/home/aniketb/scratch/saved/logs_output_paper1/emb_0_arch_1/{seed}"
log_dir = f"{base_dir}/"
...
class TabularModel(nn.Module):
    ...
    def forward(self, x_cat, x_cont):
        ...
        # Adding a ReLU activation after the embeddings
        x = F.relu(x)
